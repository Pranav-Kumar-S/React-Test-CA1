      ...
      <Fragment>
        <div className="position-relative">
          ...
          <FormField type="password" validator={this.validatePasswordStrong} onStateChanged={this.stateChanged} {...restProps}>
            <span className="d-block form-hint"><br></br>To confirm with our Strong Password policy, you are required to use a sufficiently strong password. Password must be more than 7 Characters.</span>
            {children}
