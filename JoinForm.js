...
class JoinForm extends Component {
  ...
  render() {
    ...
    return (
      <div className="form-container d-table-cell position-relative align-middle" id='formbody'>
        <form action="/" method="POST" noValidate>
          ...
          <div className="py-5 border-gray border-top border-bottom">
            ...
            <FormField type="text" fieldId="fullname" label="Fullname" placeholder="Enter Your Full Name"  onStateChanged={this.fullnameChanged} required />

            {/** Render the email field component **/}
            <EmailField fieldId="email" label="Email" placeholder="Enter Your Email Address" onStateChanged={this.emailChanged} required />

            {/** Render the password field component using thresholdLength of 7 and minStrength of 3 **/}
            <PasswordField fieldId="password" label="Password" placeholder="Enter Your Password" onStateChanged={this.passwordChanged} thresholdLength={7} minStrength={3} required />
          </div>
